@orangehrm @login @navigation @demo @TestPlanId:417 @TestSuiteId:418
Feature: Orange HRM Demo Site - Login and Navigation
  ...
  @TC501 @smoke @high @critical @TestCaseId:419
  ...
  @TC502 @regression @medium @TestCaseId:420
  ...
  @TC503 @regression @medium @TestPlanId:413 @TestSuiteId:414 @TestCaseId:{415,416}

...
export const MODE_DEFINITIONS: ModeDefinition[] = [
    ...
    },
    {
        ...
        stages: ['posture', 'author.intake', 'author.plan', 'author.clarify', 'app.context', 'author.explore', 'author.data', 'author.pipeline', 'author.verify', 'author.coverage_audit', 'finalize'],
    },
    {
        mode: 'migrate',
